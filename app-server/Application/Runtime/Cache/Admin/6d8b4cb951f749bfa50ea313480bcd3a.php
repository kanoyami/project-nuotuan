          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            <li><a href="<?php echo U('GroupDate/glist') ;?>" class="am-cf"><span class="am-icon-list"></span> 社团列表<span class=" am-fr am-margin-right admin-icon-yellow"></span></a></li>
             ...
             <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                      ...
                      <li><a href="<?php echo U('News/nlist') ;?>" class="am-cf"><span class="am-icon-list"></span> 用户列表<span class=" am-fr am-margin-right admin-icon-yellow"></span></a></li>
        </li>
...
<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">用户列表</strong> / <small>list</small></div>
  </div>
          ...
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-check"><input type="checkbox"></th><th class="table-id">ID</th><th class="table-title">用户名</th><th class="table-title">手机号</th>

              </tr>
          </thead>
          <tbody>
          <?php if(is_array($nlist)): $i = 0; $__LIST__ = $nlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form method="post" action="<?php echo U('News/newsdelete');?>">
            <tr>
              <td><input type="checkbox"> <input type="text" name="id" value="<?php echo $vo['id'];?>" style="display:none;"> </td>
              <td><?php echo $i;?></td>
