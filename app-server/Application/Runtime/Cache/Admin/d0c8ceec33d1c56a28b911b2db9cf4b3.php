...
<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">社团列表</strong> / <small>list</small></div>
  </div>
          ...
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                ...
                <th class="table-type">纬度</th>
                <th class="table-set">操作</th>
              </tr>
          </thead>
          <tbody>
          <?php if(is_array($glist)): $i = 0; $__LIST__ = $glist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form method="post" action="<?php echo U('GroupDate/groupdelete');?>">

            <?php if($vo['gid'] == 1): ?><tr style="display:none"><?php else: ?><tr><?php endif; ?>
              <td><input type="text" name="id" value="<?php echo $vo['id'];?>" style="display:none;"> </td>
              <td><?php echo $i;?></td>
